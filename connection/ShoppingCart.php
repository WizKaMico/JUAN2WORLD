...
class ShoppingCart extends DBController
{
    ...
    {
        $query = "INSERT INTO tbl_order (customer_id, tracking_number, amount, name, address, city, state, zip, country, payment_type, order_status, order_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $params = array(
            array(
             ...
             array(
                "param_type" => "s",
                "param_value" => $customer_detail["tracking_number"]
            ),
            array(
                "param_type" => "i",
                "param_value" => $amount
      ...
      function insertBuyer($customer_detail, $member_id, $amount)
    {
        $query = "INSERT INTO tbl_buyer (customer_id, tracking_number, amount, name, address, city, state, zip, country, payment_type, order_status, order_at, referral) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $params = array(
            ...
            array(
                "param_type" => "s",
                "param_value" =>  $customer_detail["referral"]
            )
        );
