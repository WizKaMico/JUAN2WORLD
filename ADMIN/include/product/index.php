		...
		<div class="col-sm-12">
			...
			<div class="row">
				...
				include_once('../../../connection/connection.php');
			     ...
			     $queries = mysqli_query($conn,"SELECT * FROM tbl_product");

			     $querieta = mysqli_query($conn,"SELECT * FROM tbl_product");
				...
				<form name="bulk_action_form" action="action_status.php" method="post" onSubmit="return delete_confirm();"/>
				...
				<form name="bulk_action_form" action="action_status3_1.php" method="post" onSubmit="return delete_confirm();"/>
