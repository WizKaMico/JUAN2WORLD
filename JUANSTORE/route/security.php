							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								 -->
									...
									<span class="stext-112 cl8">
									 ...
									 <form name="frm_customer_detail" action="action/security.php" method="POST">
									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl12 plh3 size-111 p-lr-15" type="text" name="icode" placeholder="ICODE" required>
										<input class="stext-111 cl12 plh3 size-111 p-lr-15" type="hidden" name="buyer_id" value="<?php echo $row['buyer_id']; ?>" required>
									</div>
